...
avg_loan = sum_of_loans/number_of_loans
...
if fair_value >= loan_price:
    ...
    print("The loan is too expensive and it is not worth the price")
...
anual_discount_rate = 0.2
present_value = calculate_present_value(future_value=new_loan.get("future_value"),remaining_months=new_loan.get("remaining_months"),annual_discount_rate=anual_discount_rate)
